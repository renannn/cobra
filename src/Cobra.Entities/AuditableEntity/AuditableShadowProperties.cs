...
namespace Cobra.Entities.AuditableEntity
{
    ...
    public static class AuditableShadowProperties
    {
        ...
        public static void IgnoreField(this ModelBuilder modelBuilder)
        {
        ...
        public static TReturn GetAddedShadowValued<TType, TReturn>(this TType SelectedEntry, string PropertyName) where TType : EntityEntry, IAuditableEntity
        {
            return (TReturn)SelectedEntry.Property(PropertyName).CurrentValue;
        }
        ...
        {
            Guid? userId = null;
            var userIdValue = httpContext?.User?.Identity?.GetUserId<string>();
