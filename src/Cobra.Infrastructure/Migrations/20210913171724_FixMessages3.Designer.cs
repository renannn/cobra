...
namespace Cobra.Infrastructure.Migrations
{
    ...
    [Migration("20210913171724_FixMessages3")]
    partial class FixMessages3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cobra.Entities.Crm.MensageUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cobra.Entities.Crm.MensageUser", b =>
                {
                    b.HasOne("Cobra.Entities.Administration.User", "ReceiverUser")
                        .WithMany("ReceivedMensagesUser")
                        .HasForeignKey("ReceiverUserId")
                        .HasConstraintName("cnst_users_messages_receiver_user")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Cobra.Entities.Administration.User", "SenderUser")
                        .WithMany("SendedMensagesUser")
                        .HasForeignKey("SenderUserId")
            ...
            modelBuilder.Entity("Cobra.Entities.Crm.MessageBuyList", b =>
                {
                    ...
                    b.HasOne("Cobra.Entities.Administration.User", "ReceiverUser")
                        .WithMany("ReceivedMessagesBuyList")
                        .HasForeignKey("ReceiverUserId")
                        .HasConstraintName("cnst_users_buylists_messagens_receiver_user")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Cobra.Entities.Administration.User", "SenderUser")
                        .WithMany("SendedMessagesBuyList")
                        .HasForeignKey("SenderUserId")
            ...
            modelBuilder.Entity("Cobra.Entities.Administration.User", b =>
                {
                    ...
                    b.Navigation("ReceivedMensagesUser");
